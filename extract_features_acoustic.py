...
def extract_feature_pipeline(args):
    ...
    data_object = DataZarr(frequencies=[18, 38, 120, 200], patch_size=args.window_size, partition_train='selected surveys',
                           train_surveys=[2007],
                           validation_surveys=[2017], partition_predict=[],
                           evaluation_surveys=[], save_prediction_surveys=False, eval_mode='all',
                           sampling_strategy=args.sampling_strategy_acoustic, patch_overlap=0)  # Training definition is not important here
    data_loader = \
    define_data_loaders(data_object, batch_size=args.batch_size_per_gpu, iterations=2, test_iter=args.test_iter,
                        patch_size=args.window_size, meta_channels=[], num_workers=args.num_workers)[1]  # dataloader_test
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_weights',
                        default='/scratch/disk5/ahmet/dino_output/200ep_acoustics_8w_RANDOM_9_TrainSurveys_NEAREST_ResNet18Modified_128NONNormalized_30Warmup_1e5-0005LR_8192Out_FixAug/checkpoint.pth',
    ...
    parser.add_argument('--test_iter', default=801, type=int, # 75 for Gridded_Portion yani echogram painting, 801 for Gridded_Predefined
                        help='Number of iterations for test dataloader.')
    parser.add_argument('--output', default='/scratch/disk5/ahmet/dino_output/extracted_features/200ep_acoustics_8w_RANDOM_9_TrainSurveys_NEAREST_ResNet18Modified_128NONNormalized_30Warmup_1e5-0005LR_8192Out_FixAug_2017_GriddedAll_NoCenterCrop_IgnoredFish.csv',
    ...
    parser.add_argument("--sampling_strategy_acoustic", default='Gridded_PreDefined_All',
