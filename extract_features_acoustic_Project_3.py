...
def extract_feature_pipeline(args):
    ...
    elif args.sampling_strategy_acoustic == 'Echogram_Painting_Project_3':
        with open('/scratch/disk5/ahmet/dino_plain/Project_3/list_overlapping_echogram_painting_2017_8w_ping_1286200.pkl', "rb") as f:
            test_list = pickle.load(f)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_iter', default=4960, type=int, # 205 for Echogram Painting, 801 for Gridded_Predefined (5000 for Model25_Balanced_320000_8w, and 64 batch size)
    ...
    parser.add_argument('--output', default='/scratch/disk5/ahmet/dino_plain//Project_3/Overlapping_features_echogram_1289700_2017.csv',
