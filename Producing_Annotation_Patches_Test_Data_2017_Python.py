...
def process_patch(patch_index):
    ...
    dat1 = sv_data.isel(ping_time=ping_slice, range=range_slice).values
...
sv_array = xr.open_zarr(f'/scratch/disk5/ahmet/data/{years[y]}/{year_codes[y]}/ACOUSTIC/GRIDDED/{year_codes[y]}_labels.zarr').annotation
...
with open(f'/scratch/disk5/ahmet/data/8w_Sampled_Data_9Years/list_undersampled_{years[y]}_ANNOTATIONS_8w_.pkl', "wb") as f:
